              ...
              <button className="relative p-2 rounded-full bg-slate-800 hover:bg-slate-700 transition-colors duration-200">
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M15 17h5l-5-5V9a6 6 0 00-12 0v3l-5 5h5m0 0v1a3 3 0 006 0v-1"
                  />
                </svg>
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5M18 4a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6a2 2 0 012-2h2z"
                  />
                </svg>
                Write
              </Link>
